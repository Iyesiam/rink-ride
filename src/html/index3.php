...
if ($countResult && $countResult->num_rows > 0) {
    ...
    $userCount = 0; // Default to 0 if the count query fails
}
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="card overflow-hidden rounded-2">
                        <div class="card-body pt-3 p-4">
                            ...
                            <p class="fs-5">Total Products: <span id="productCountPlaceholder">Loading...</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="card overflow-hidden rounded-2">
                        <div class="card-body pt-3 p-4">
                            <h6 class="fw-semibold fs-4">Orders</h6>
                            <p class="fs-5">Total Orders: <span id="orderCountPlaceholder">Loading...</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
